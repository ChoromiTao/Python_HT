# Урок 1. Ввод-Вывод, операторы ветвления (Папка 04.07.23)
## Задача 2: 
...
# Урок 3. Списки и словари (папка 04.14.23)
...
# Урок 4. Словари, множества и профилирование (папка 04.18.23)
## Задача 22: 
...
# Урок 5. Рекурсия и алгоритмы (папка 04.21.23)
## Задача 26:  
